...
export const TOOL_META: Record<ToolType, {
  ...
  validator: {
    ...
    placeholder: "Paste your idea, stack description, or what you are building. What problem does it solve? Who is it for?\n\nBe direct — 2–5 sentences is enough.",
    loadingMessages: [
      "Axiom is analyzing your build…",
  ...
  sprint: {
    ...
    badge: "Sequenced execution steps",
    placeholder: "Paste your idea, stack description, or what you are building. Who is it for? What problem does it solve?\n\nThe more detail, the more specific your execution path.",
    loadingMessages: [
      "Axiom is analyzing your build…",
      "Reading your build carefully…",
